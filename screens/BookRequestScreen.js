...
import { View, StyleSheet, Text, FlatList, TouchableOpacity, KeyboardAvoidingView, SnapshotViewIOSBase } from 'react-native';
...
export default class BookRequestScreen extends Component {
    ...
    getBookRequest = () => { // getting the requested book 
    ...
    updateBookRequestStatus = () => { //updating the book status after receiving the book 
